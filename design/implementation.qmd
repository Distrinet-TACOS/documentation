...
As explained earlier in this documentation, the *Buildroot* build system is used to build the complete package for the Sabre Lite board. For this process, the same steps are followed as explained in that section. However, an extra external Buildroot tree is added
